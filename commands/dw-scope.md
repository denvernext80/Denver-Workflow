...
- **user(전역)**:    `python3 "${CLAUDE_PLUGIN_ROOT}/_build/dw.py" plugin-scope-user`
- **project(여기만)**: `python3 "${CLAUDE_PLUGIN_ROOT}/_build/dw.py" plugin-scope-project`
- **off**:           `python3 "${CLAUDE_PLUGIN_ROOT}/_build/dw.py" plugin-scope-off --project .`
